...
public class TesteServicoMensagem {
	...
	public void Mutacoes() {
		...
		Mensagem msgSent = servicoEnvioDeMensagem.enviar(mensagem, usuario);
		Assert.assertNotNull(msgSent);	
		servicoMensagem.adiocionarNumeroMensagensNaolidas(idUsuarioTeste, idUsuarioTeste2);
		...
		msgs = servicoMensagem.ultimasMensagens(idUsuarioTeste, idUsuarioTeste2, 0L);
		Mensagem msgSent2 = msgs.get(msgs.size()-1);
		
		System.out.println(msgSent2.get_id() + " = " + msgSent.get_id());
		
		Assert.assertEquals(msgSent2.get_id(), msgSent.get_id());
		Assert.assertEquals(msgSent2.getDestinatario(), msgSent.getDestinatario());
		Assert.assertEquals(msgSent2.getMensagem(), msgSent.getMensagem());
		Assert.assertEquals(msgSent2.getNomeDestinatario(), msgSent.getNomeDestinatario());
		Assert.assertEquals(msgSent2.getNomeRemetente(), msgSent.getNomeRemetente());
		Assert.assertEquals(msgSent2.getRemetente(), msgSent.getRemetente());
		Assert.assertEquals(msgSent2.getTimestamp(), msgSent.getTimestamp());
		Assert.assertEquals(msgSent2.getTipoMensagem(), msgSent.getTipoMensagem());
		Assert.assertEquals(msgSent2.getIdParaSubstituir(), msgSent.getIdParaSubstituir());
		Assert.assertEquals(msgSent2.getUrl(), msgSent.getUrl());
