...
public class TesteServicoDeNoticia {
	...
	public void SimularCRUD() {
		...
		//ADICIONAR
		Noticia noticiaCriada = servicoNoticia.salvar(noticia);
		//se foia dicionado o id é diferente de null ou de ""
		noticia = servicoNoticia.buscar(noticiaCriada.get_id());
	...
	public void SimularMutacoes() {
		...
		Assert.assertEquals(noticia.get_id(), noticiaCriada.get_id());
		Assert.assertEquals(noticia.getAutor(), noticiaCriada.getAutor());
		Assert.assertEquals(noticia.getResumo(), noticiaCriada.getResumo());
		Assert.assertEquals(noticia.getTexto(), noticiaCriada.getTexto());
		Assert.assertEquals(noticia.getTitulo(), noticiaCriada.getTitulo());
		Assert.assertEquals(noticia.getUrlCapa(), noticiaCriada.getUrlCapa());
		
		Assert.assertEquals(noticia.getPrioridade(), noticiaCriada.getPrioridade());
		Assert.assertEquals(noticia.getPublicador().getEmail(), noticiaCriada.getPublicador().getEmail());
